...
class LockCtrl {
    ...
    let e = t.currentTarget.getBoundingClientRect(),
      x = Math.max(
        ...
        Math.min(
          ...
          Math.round(
            (PatternSVG.prototype.SVG_WIDTH / e.width) * (t.pageX - e.left),
          ),
        ),
      ),
      y = Math.max(
        ...
        Math.min(
          PatternSVG.prototype.SVG_WIDTH,
          Math.round(
            (PatternSVG.prototype.SVG_WIDTH / e.height) * (t.pageY - e.top),
          ),
        ),
      );
    ...
    let e = t.currentTarget.getBoundingClientRect(),
      x = Math.max(
        ...
        Math.min(
          PatternSVG.prototype.SVG_WIDTH,
          Math.round(
            (PatternSVG.prototype.SVG_WIDTH / e.width) *
      ...
      y = Math.max(
        ...
        Math.min(
          PatternSVG.prototype.SVG_WIDTH,
          Math.round(
            (PatternSVG.prototype.SVG_WIDTH / e.height) *
  ...
  triggerDot(dotIndex) {
    ...
    newDots.forEach((dot, index) => {
      let dotX =
          PatternSVG.prototype.GRID_GUTTER * (dot % 3) +
          PatternSVG.prototype.SVG_MARGIN,
        dotY =
          PatternSVG.prototype.GRID_GUTTER * Math.floor(dot / 3) +
          PatternSVG.prototype.SVG_MARGIN;
  ...
  checkPattern() {
    ...
    this.patternEl.setAttribute(
      "stroke",
      itsAmatch ? config.COLORS.SUCCESS : config.COLORS.ERROR,
    );
